$(document).ready(function() {
    $("#add").click(function(){
        ...
        if(currentLength < 11) {
                ...
                <div class="tab-pane fade active show" id="tab-${randomNum}" role="tabpanel" aria-labelledby="tab-no-${randomNum}">
                    <div class="row p-2">
                        ...
                        <div class="col-sm-8 right-side">
                            <div class="tab">
                                <button class="tablinks active" id="text_view_button_${randomNum}" onclick="textView_tab_onClick(${randomNum})">Text View</button>
                                <button class="tablinks" id="json_view_button_${randomNum}" onclick="jsonView_tab_onClick(${randomNum})">JSON View</button>
                            </div>
                            <div id="text_view_content_${randomNum}" class="tabcontent text_view show shadow-sm">
                            ...
                            <div id="json_view_content_${randomNum}" class="tabcontent hide shadow-sm">
                                    <div class="form-group">
            ...
            `;
            $(".tab-pane").filter(".active").removeClass('active show');
